               ...
               <div class="panel-body">
                  <form action="Edit_trip.php" method="post">
                     <div class="form-group">
                        ...
                        <div class="row">
                           <div class="col-md-8">
                              <input type="text" class="form-control" value=<?php echo $trip_no; ?>  name="tid">
                           </div>
				  ...
				  <div class="form-group">
                     ...
                     <input type="text" class="form-control" value=<?php echo $t_id; ?> name="nos">
                  </div>
                 <div class="form-group">
                     <label for="usr">Starting Station:</label>
                     <input type="text" class="form-control" value=<?php echo $s_s; ?> name="nos">
                  </div><div class="form-group">
                     <label for="usr">Starting Time:</label>
                     <input type="text" class="form-control" value=<?php echo $s_t; ?> name="nos">
                  </div><div class="form-group">
                     <label for="usr">End Station:</label>
                     <input type="text" class="form-control" value=<?php echo $e_s; ?> name="nos">
                  </div><div class="form-group">
                     <label for="usr">End Time:</label>
                     <input type="text" class="form-control" value= <?php echo $e_t; ?> name="nos">
                  </div>
				  
                 
             
				   <form action="Edit_trip_handle.php" method="post">
                  <div class=col-md-2>
                     <button type="submit" class="btn btn-success">Save</button>
                     </div>
					  </form>
                  <div class=col-md-4></div>
				   <form action="Delete_trip_handle.php" method="post">
                  <div class=col-md-2>
